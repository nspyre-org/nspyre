...
nspyre_palette.setColor(QtGui.QPalette.ColorRole.ButtonText, QtGui.QColor(*almost_white))
...
nspyre_palette.setColor(QtGui.QPalette.ColorRole.LinkVisited, QtGui.QColor(42, 130, 218))
nspyre_palette.setColor(QtGui.QPalette.ColorRole.Mid, QtGui.QColor(*avg_colors(dark_grey, blackish)))
nspyre_palette.setColor(QtGui.QPalette.ColorRole.Midlight, QtGui.QColor(*avg_colors(dark_grey, grey)))
...
nspyre_palette.setColor(QtGui.QPalette.ColorRole.ToolTipText, QtGui.QColor(*almost_white))
nspyre_palette.setColor(QtGui.QPalette.ColorRole.Window, QtGui.QColor(*dark_grey))
nspyre_palette.setColor(QtGui.QPalette.ColorRole.WindowText, QtGui.QColor(*almost_white))
